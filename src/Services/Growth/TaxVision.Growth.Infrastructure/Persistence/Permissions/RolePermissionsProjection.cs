...
/// <summary>
/// Cache local de permisos por rol (RBAC Fase 7/8, mismo patrón que CloudStorage/Customer/etc):
...
/// permisos heredados de sus otros roles. Ver <see cref="UserPermissionsProjection"/> para por qué
/// vive en Growth.Infrastructure y no en un proyecto "Growth.Domain" (no existe).
/// </summary>
