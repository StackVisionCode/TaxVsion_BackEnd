...
{
    public static void ConfigureMoney<TOwner>(this OwnedNavigationBuilder<TOwner, Money> builder, string columnPrefix)
        where TOwner : class
    {
    ...
    public static void ConfigureDisplay<TOwner>(
        ...
        where TOwner : class
    {
        builder.Property(value => value.Prefix).HasColumnName($"{columnPrefix}Prefix").HasMaxLength(12).IsRequired();
        builder
    ...
    public static void ConfigureSubject<TOwner>(this OwnedNavigationBuilder<TOwner, SubjectReference> builder)
        where TOwner : class
    {
        builder
            ...
            .HasMaxLength(30)
            .IsRequired();
        builder.Property(value => value.SubjectId).HasColumnName("SubjectId").HasMaxLength(200).IsRequired();
    }

    public static void ConfigureOffer<TOwner>(this OwnedNavigationBuilder<TOwner, OfferReference> builder)
        where TOwner : class
    {
        ...
        builder.Property(value => value.OfferVersion).HasColumnName("OfferVersion").HasMaxLength(100).IsRequired();
    }

    public static void ConfigurePayment<TOwner>(this OwnedNavigationBuilder<TOwner, PaymentReference> builder)
        where TOwner : class
    {
