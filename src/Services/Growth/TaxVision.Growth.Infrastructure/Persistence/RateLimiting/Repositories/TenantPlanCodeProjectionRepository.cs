...
namespace TaxVision.Growth.Infrastructure.Persistence.RateLimiting.Repositories;
...
public sealed class TenantPlanCodeProjectionRepository(GrowthDbContext db) : ITenantPlanCodeProjectionRepository
{
