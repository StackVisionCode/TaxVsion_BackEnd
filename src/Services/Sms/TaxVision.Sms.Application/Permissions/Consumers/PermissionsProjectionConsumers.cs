...
namespace TaxVision.Sms.Application.Permissions.Consumers;
...
// HTTP en el hot path de autorización. Mismo patrón que Scribe/Notification/Signature:
// idempotente por PermissionsVersion, union-recompute en RolePermissionsChanged para no perder
// permisos de un usuario multi-rol. Wolverine descubre los métodos estáticos `Handle` por
// convención (Discovery.IncludeAssembly del AssemblyMarker de Application).
// ---------------------------------------------------------------------------
