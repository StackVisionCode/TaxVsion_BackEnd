...
namespace TaxVision.Signature.Application.Templates.Commands.RevertToDraft;

public sealed record RevertTemplateToDraftCommand(Guid TenantId, Guid TemplateId);

public static class RevertTemplateToDraftHandler
{
    public static async Task<Result> Handle(
        RevertTemplateToDraftCommand cmd,
