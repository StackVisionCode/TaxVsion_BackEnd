...
namespace TaxVision.Subscription.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260905184241_WidenUserPermissionsProjectionCodesToMax")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaxVision.Subscription.Domain.AddOns.TenantAddOnRenewal", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantAddOnId");

                    b.HasIndex("Status", "NextRetryAtUtc")
                        .HasDatabaseName("IX_TenantAddOnRenewals_Status_NextRetry");

                    b.ToTable("TenantAddOnRenewals", (string)null);
                });

            modelBuilder.Entity("TaxVision.Subscription.Domain.Audit.SubscriptionAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TaxVision.Subscription.Domain.Permissions.RolePermissionsProjection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TaxVision.Subscription.Domain.Permissions.UserPermissionsProjection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TaxVision.Subscription.Domain.RateLimiting.TenantPlanCodeProjection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TaxVision.Subscription.Domain.Seats.SubscriptionSeatRenewal", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SubscriptionSeatRenewals", (string)null);
                });
            ...
            modelBuilder.Entity("TaxVision.Subscription.Domain.Subscriptions.TenantSubscriptionRenewal", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TenantSubscriptionRenewals", (string)null);
                });
            ...
            modelBuilder.Entity("TaxVision.Subscription.Domain.AddOns.TenantAddOnRenewal", b =>
                {
                    b.HasOne("TaxVision.Subscription.Domain.AddOns.TenantAddOn", null)
                        .WithMany("Renewals")
                        .HasForeignKey("TenantAddOnId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
