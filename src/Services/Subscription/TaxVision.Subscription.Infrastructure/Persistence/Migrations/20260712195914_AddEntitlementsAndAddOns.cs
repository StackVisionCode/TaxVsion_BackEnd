...
namespace TaxVision.Subscription.Infrastructure.Persistence.Migrations
{
    ...
    public partial class AddEntitlementsAndAddOns : Migration
    {
        ...
        {
            migrationBuilder.DropTable(name: "AddOnEntitlementDefinitions");

            migrationBuilder.DropTable(name: "AddOnFeatures");

            migrationBuilder.DropTable(name: "AddOnPriceTiers");

            migrationBuilder.DropTable(name: "TenantAddOns");

            migrationBuilder.DropTable(name: "TenantEntitlementSnapshots");
