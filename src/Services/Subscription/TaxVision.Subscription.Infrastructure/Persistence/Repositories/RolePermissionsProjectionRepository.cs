...
public sealed class RolePermissionsProjectionRepository(SubscriptionDbContext db) : IRolePermissionsProjectionRepository
{
    ...
    // TenantContext ambiente (no hay HTTP request), así que el filtro global de tenant de SubscriptionDbContext
