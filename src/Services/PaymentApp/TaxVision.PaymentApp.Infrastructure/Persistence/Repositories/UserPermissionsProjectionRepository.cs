...
public sealed class UserPermissionsProjectionRepository(PaymentAppDbContext db)
        ...
        IUserPermissionsProjectionReader
{
    ...
    // ambiente (no hay HTTP request), así que el filtro global de tenant de PaymentAppDbContext tira antes
