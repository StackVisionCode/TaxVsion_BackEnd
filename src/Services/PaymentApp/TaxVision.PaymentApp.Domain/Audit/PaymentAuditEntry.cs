...
/// <summary>
/// Registro inmutable de un cambio en cualquier aggregate de PaymentApp (append-only — sin
/// métodos de mutación además del factory). No cuelga de otro aggregate: cada entrada es su
/// propia raíz, escrita directamente por <c>IPaymentAuditLogWriter</c>. Nunca se hard-delete
/// (retención indefinida, compliance financiero — §46 del diseño).
/// </summary>
