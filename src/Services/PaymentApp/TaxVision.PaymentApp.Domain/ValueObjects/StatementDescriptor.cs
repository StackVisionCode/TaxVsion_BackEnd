...
/// <summary>
/// Texto que aparece en el estado de cuenta del tarjetahabiente (p.ej. "TAXVISION SAAS").
/// Restringido a lo que Stripe/most card networks aceptan: 5-22 caracteres, sin
/// &lt;, &gt;, \, ', ", *.
/// </summary>
