...
/// reflectivo en <c>AddPaymentAppInfrastructure(...)</c> la descubra y la registre en DI
/// keyed por <see cref="Code"/>. Agregar un provider nuevo requiere únicamente crear la
/// clase y decorarla — cero cambios en <c>DependencyInjection.cs</c> (guardrail §44.4).
/// </summary>
