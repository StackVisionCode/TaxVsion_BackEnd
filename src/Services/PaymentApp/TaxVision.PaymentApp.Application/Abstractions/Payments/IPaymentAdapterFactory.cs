...
/// <summary>
/// Único punto de resolución de un <see cref="IPaymentProvider"/>. Application jamás
/// resuelve providers por nombre string ni hace <c>switch(provider)</c> disperso — todo
/// despacho pasa por <see cref="Resolve"/> (guardrail §44.1 ley 2).
/// </summary>
