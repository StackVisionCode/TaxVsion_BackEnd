...
namespace TaxVision.Catalog.Application.Permissions.Consumers;

// RBAC Fase 7 — mantiene la proyección local de permisos que consulta ProjectionPermissionsSource
// para enforzar perm_v sin llamar a Auth en el hot path. Mismo patrón que Sms/Scribe. Wolverine
// descubre los métodos estáticos `Handle`; se registran EXPLÍCITO en Program.cs (Discovery.IncludeType)
// porque la discovery convencional no siempre levanta clases estáticas.
