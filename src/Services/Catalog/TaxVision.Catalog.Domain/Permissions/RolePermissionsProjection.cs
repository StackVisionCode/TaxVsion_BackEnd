...
/// <summary>Cache local de permisos por rol (RBAC Fase 7, mismo patrón que Sms/Scribe): permite
/// recomputar la unión de permisos de un usuario multi-rol cuando llega
/// <c>RolePermissionsChangedIntegrationEvent</c> para SOLO uno de sus roles.</summary>
