...
namespace TaxVision.Catalog.Domain.Permissions;
...
/// Mismo shape que la proyección homónima de Sms/Scribe — <c>RoleIds</c> permite recomputar la unión
/// de permisos de un usuario multi-rol cuando llega <c>RolePermissionsChangedIntegrationEvent</c> para
/// SOLO uno de sus roles, sin perder los heredados de sus otros roles.
/// </summary>
