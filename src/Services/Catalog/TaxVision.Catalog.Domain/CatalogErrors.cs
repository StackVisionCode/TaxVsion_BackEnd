...
public static class CatalogErrors
{
    ...
    public static Error InvalidName => new("catalog.invalidName", "Name is required and must be within the max length.");
    ...
    public static Error CategoryHasChildren => new("catalog.categoryHasChildren", "The category has subcategories or items.");
}
