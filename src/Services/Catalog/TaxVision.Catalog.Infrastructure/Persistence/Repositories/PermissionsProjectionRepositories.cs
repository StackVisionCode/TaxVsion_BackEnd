...
// RBAC Fase 7: una sola instancia scoped satisface el puerto local rico (para los consumers) y el
// puerto compartido y angosto de BuildingBlocks (IUserPermissionsProjectionReader, para autorizar).
public sealed class UserPermissionsProjectionRepository(CatalogDbContext db)
