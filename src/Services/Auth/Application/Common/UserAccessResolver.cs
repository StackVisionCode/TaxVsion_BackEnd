...
{
    public static async Task<(IReadOnlyList<string> Roles, IReadOnlyList<string> Permissions)>
        ResolveAsync(User user, IRoleRepository roles, CancellationToken ct = default)
    {
        ...
        IReadOnlyList<string> permissions =
            await roles.GetEffectivePermissionCodesAsync(user.Id, ct);
