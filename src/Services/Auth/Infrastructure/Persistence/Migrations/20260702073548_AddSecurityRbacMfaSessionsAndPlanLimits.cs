    ...
    public partial class AddSecurityRbacMfaSessionsAndPlanLimits : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a1000000-0000-0000-0000-000000000001"), "users.view", "Ver usuarios del tenant", false, "users" },
                    { new Guid("a1000000-0000-0000-0000-000000000002"), "users.invite", "Invitar usuarios", false, "users" },
                    { new Guid("a1000000-0000-0000-0000-000000000003"), "users.manage", "Activar, desactivar y editar usuarios", false, "users" },
                    { new Guid("a1000000-0000-0000-0000-000000000004"), "roles.manage", "Gestionar roles y permisos", false, "users" },
                    { new Guid("a1000000-0000-0000-0000-000000000005"), "audit.view", "Consultar auditoría", false, "audit" },
                    { new Guid("a1000000-0000-0000-0000-000000000006"), "settings.manage", "Gestionar configuración del tenant", false, "settings" },
                    { new Guid("a1000000-0000-0000-0000-000000000007"), "billing.view", "Ver facturación y suscripción", false, "billing" },
                    { new Guid("a1000000-0000-0000-0000-000000000008"), "billing.manage", "Gestionar métodos de pago y facturación", false, "billing" },
                    { new Guid("a1000000-0000-0000-0000-000000000009"), "subscription.manage", "Cambiar plan y gestionar suscripción", false, "billing" },
                    { new Guid("a1000000-0000-0000-0000-000000000010"), "customers.view", "Ver clientes", false, "customers" },
                    { new Guid("a1000000-0000-0000-0000-000000000011"), "customers.manage", "Crear y editar clientes", false, "customers" },
                    { new Guid("a1000000-0000-0000-0000-000000000012"), "signatures.request", "Solicitar firmas", false, "signatures" },
                    { new Guid("a1000000-0000-0000-0000-000000000013"), "documents.view", "Ver documentos", false, "documents" },
                    { new Guid("a1000000-0000-0000-0000-000000000014"), "documents.manage", "Gestionar documentos", false, "documents" },
                    { new Guid("a1000000-0000-0000-0000-000000000015"), "email.use", "Usar el módulo de correo", false, "email" },
                    { new Guid("a1000000-0000-0000-0000-000000000016"), "comms.calls", "Realizar llamadas y meetings", false, "comms" },
                    { new Guid("a1000000-0000-0000-0000-000000000017"), "campaigns.manage", "Gestionar campañas", false, "campaigns" },
                    { new Guid("a1000000-0000-0000-0000-000000000018"), "reports.view", "Ver dashboard y reportes", false, "reports" },
                    { new Guid("a1000000-0000-0000-0000-000000000019"), "portal.calls.use", "El cliente puede realizar llamadas", true, "portal" },
                    { new Guid("a1000000-0000-0000-0000-000000000020"), "portal.miles.use", "El cliente puede usar el módulo de millas", true, "portal" },
                    { new Guid("a1000000-0000-0000-0000-000000000021"), "portal.folders.view", "El cliente puede ver folders de su perfil", true, "portal" },
                    { new Guid("a1000000-0000-0000-0000-000000000022"), "portal.signatures.sign", "El cliente puede firmar documentos", true, "portal" }
                });
