...
public sealed class UsersController(IMessageBus bus) : ControllerBase
{
        ...
        CancellationToken ct = default)
    {
        ...
        var result = await bus.InvokeAsync<Result<PagedResult<UserSummaryResponse>>>(
            new GetUsersQuery(tenantId, page, size, search, isActive), ct);
        ...
        CancellationToken ct)
    {
        ...
        var result = await bus.InvokeAsync<Result<UserSummaryResponse>>(
            new GetUserByIdQuery(tenantId, userId), ct);
        ...
        CancellationToken ct)
    {
        ...
        var result = await bus.InvokeAsync<Result>(
            new DeactivateUserCommand(tenantId, userId, requesterId), ct);
        ...
        CancellationToken ct)
    {
        ...
        var result = await bus.InvokeAsync<Result>(
            new ReactivateUserCommand(tenantId, userId, requesterId), ct);
        ...
        CancellationToken ct)
    {
        ...
        var result = await bus.InvokeAsync<Result>(
            new AssignUserRolesCommand(tenantId, userId, request.RoleIds, requesterId), ct);
    ...
    public async Task<IActionResult> GetTenantLimits(CancellationToken ct)
    {
        ...
        var result = await bus.InvokeAsync<Result<TenantLimitsResponse>>(
            new GetTenantLimitsQuery(tenantId), ct);
