...
namespace TaxVision.Postmaster.Domain.RateLimiting;

/// <summary>
/// RateLimit Fase 2 — proyección local de "¿qué PlanCode tiene este tenant hoy?", mismo patrón
/// que la copia original de Customer (Fase 6), la de Tenant (Fase 2.1) y que
/// <c>UserPermissionsProjection</c> (RBAC Fase 7) dentro de este mismo servicio. Implementa
