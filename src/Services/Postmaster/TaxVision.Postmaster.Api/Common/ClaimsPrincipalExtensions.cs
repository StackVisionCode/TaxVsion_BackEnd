...
namespace TaxVision.Postmaster.Api.Common;

/// <summary>
/// Lectura de identidad y permisos desde el JWT validado — mismo criterio que
/// Signature/Notification/Customer. El <c>tenant_id</c> siempre proviene del token, nunca del
/// cuerpo/query del cliente (aislamiento multitenant estricto). TenantAdmin y PlatformAdmin pasan
/// siempre; el resto necesita el permiso explícito.
/// </summary>
