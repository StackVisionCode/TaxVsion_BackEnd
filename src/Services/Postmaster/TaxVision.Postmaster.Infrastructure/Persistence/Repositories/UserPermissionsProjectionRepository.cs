...
public sealed class UserPermissionsProjectionRepository(PostmasterDbContext db)
        ...
        IUserPermissionsProjectionReader
{
    ...
    // ambiente (no hay HTTP request), así que el filtro global de tenant de PostmasterDbContext tira antes
