...
public sealed class TenantEmailProviderConfiguration : IEntityTypeConfiguration<TenantEmailProvider>
{
    public void Configure(EntityTypeBuilder<TenantEmailProvider> builder)
    {
        ...
        builder.HasIndex(p => new { p.TenantId, p.ProviderCode }).IsUnique();
    }
}
