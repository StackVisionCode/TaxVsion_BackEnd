...
public static class UpsertTenantEmailProviderHandler
{
    public static async Task<Result> Handle(
        UpsertTenantEmailProviderCommand cmd,
    ...
    )
    {
        ...
        var existing = await repository.GetByCodeAsync(cmd.TenantId, cmd.ProviderCode, ct);
    ...
    {
        var createResult = TenantEmailProvider.Create(
            cmd.TenantId,
            cmd.ProviderCode,
            cmd.DisplayName,
            cmd.ProviderType,
