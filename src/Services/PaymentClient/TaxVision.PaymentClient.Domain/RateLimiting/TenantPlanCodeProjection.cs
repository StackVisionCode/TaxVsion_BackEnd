...
namespace TaxVision.PaymentClient.Domain.RateLimiting;

/// <summary>
/// RateLimit Fase 2 — proyección local de "¿qué PlanCode tiene este tenant hoy?", mismo patrón
/// que Tenant/CloudStorage y que <c>UserPermissionsProjection</c> (RBAC Fase 7) dentro de este
/// mismo servicio. Implementa <see cref="ITenantPlanCodeProjection"/> para que el handler
