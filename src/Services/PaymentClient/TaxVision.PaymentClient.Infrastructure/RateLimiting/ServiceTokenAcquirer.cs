...
namespace TaxVision.PaymentClient.Infrastructure.RateLimiting;
...
/// <summary>
/// Auditoria RateLimit hallazgo #2 — PaymentClient nunca tuvo un acquirer M2M saliente (es un
/// receptor M2M puro vía InternalPayablesController, no un llamador). Este acquirer existe
/// solo para que HttpPlanRateLimitReader pueda pedirle a Subscription el catálogo de
/// PlanRateLimits — mismo patrón que Customer/Tenant (F25).
/// </summary>
