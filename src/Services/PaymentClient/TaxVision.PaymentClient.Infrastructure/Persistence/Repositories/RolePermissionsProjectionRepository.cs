...
public sealed class RolePermissionsProjectionRepository(PaymentClientDbContext db)
    : IRolePermissionsProjectionRepository
{
    ...
    // PaymentClientDbContext tira antes de llegar acá. tenantId ya viene explícito y confiable desde el
