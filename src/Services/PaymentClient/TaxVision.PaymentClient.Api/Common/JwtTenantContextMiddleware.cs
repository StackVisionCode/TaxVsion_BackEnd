...
/// autenticado. El header <c>X-Tenant-Id</c> se ignora por completo — un servicio de pagos no
/// confía en un header spoofeable. Se ejecuta después de <c>UseAuthentication</c> y antes de
/// <see cref="TenantStatusGateMiddleware"/>.
/// </summary>
