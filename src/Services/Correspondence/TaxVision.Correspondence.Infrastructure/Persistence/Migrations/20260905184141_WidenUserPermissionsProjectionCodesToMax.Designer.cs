...
namespace TaxVision.Correspondence.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260905184141_WidenUserPermissionsProjectionCodesToMax")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaxVision.Correspondence.Domain.Audit.CorrespondenceAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("CorrespondenceAuditLogs", (string)null);
                });
            ...
            modelBuilder.Entity("TaxVision.Correspondence.Domain.Compose.Draft", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "CustomerId", "Status", "UpdatedAtUtc")
            ...
            modelBuilder.Entity("TaxVision.Correspondence.Domain.Compose.DraftRecipient", b =>
                {
                    ...
                    b.ToTable("DraftRecipients", (string)null);
                });
            ...
            modelBuilder.Entity("TaxVision.Correspondence.Domain.Inbox.IncomingEmail", b =>
                {
                    ...
                    b.HasIndex("TenantId", "EmailThreadId")
                    ...
                    b.HasIndex("TenantId", "EmailThreadId", "ReceivedAtUtc")
            ...
            modelBuilder.Entity("TaxVision.Correspondence.Domain.Permissions.RolePermissionsProjection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TaxVision.Correspondence.Domain.Permissions.UserPermissionsProjection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
