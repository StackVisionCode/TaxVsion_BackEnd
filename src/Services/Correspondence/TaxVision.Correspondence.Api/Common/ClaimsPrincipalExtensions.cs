...
namespace TaxVision.Correspondence.Api.Common;
...
/// nunca del cuerpo/query del cliente (aislamiento multitenant estricto). TenantAdmin y
/// PlatformAdmin pasan siempre; el resto necesita el permiso explícito.
/// </summary>
