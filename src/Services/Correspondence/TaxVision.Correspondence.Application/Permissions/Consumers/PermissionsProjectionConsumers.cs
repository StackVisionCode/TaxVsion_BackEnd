...
namespace TaxVision.Correspondence.Application.Consumers;
...
// HTTP en el hot path de autorización. Mismo patrón que Notification/Signature (Fase 4 del plan
// de notificaciones dinámicas): idempotente por PermissionsVersion, union-recompute en
// RolePermissionsChanged para no perder permisos de un usuario multi-rol.
// ---------------------------------------------------------------------------
