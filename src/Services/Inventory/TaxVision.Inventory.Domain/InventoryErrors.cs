...
public static class InventoryErrors
{
    ...
    public static Error InvalidName => new("inventory.invalidName", "Name is required and must be within the max length.");
    ...
    public static Error InvalidCurrency => new("inventory.invalidCurrency", "Currency must be a 3-letter ISO 4217 code.");

    public static Error InsufficientStock => new("inventory.insufficientStock", "The movement would drive stock below zero.");
