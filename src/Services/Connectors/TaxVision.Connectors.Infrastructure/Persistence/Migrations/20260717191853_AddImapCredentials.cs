...
{
    /// <inheritdoc />
    public partial class AddImapCredentials : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImapCredentials", x => x.Id);
                }
            );

            migrationBuilder.CreateIndex(
                name: "IX_ImapCredentials_AccountId",
                table: "ImapCredentials",
                column: "AccountId",
                unique: true
            );
        }
        ...
        {
            migrationBuilder.DropTable(name: "ImapCredentials");
        }
    }
}
