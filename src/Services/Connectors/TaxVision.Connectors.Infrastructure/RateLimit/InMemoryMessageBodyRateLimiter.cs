...
/// <summary>Fallback single-node cuando Redis no está configurado — mismo contrato que <see cref="RedisMessageBodyRateLimiter"/>, sin coordinación entre réplicas.</summary>
public sealed class InMemoryMessageBodyRateLimiter(IOptions<MessageBodyRateLimiterOptions> options)
