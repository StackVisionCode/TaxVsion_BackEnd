...
/// <summary>
/// Auditoria RateLimit hallazgo #2 — Connectors nunca tuvo infraestructura de token M2M
/// saliente (solo RECIBIA llamadas M2M, nunca las hacia). Este acquirer existe solo para que
/// HttpPlanRateLimitReader pueda pedirle a Subscription el catálogo de PlanRateLimits — mismo
/// patrón que Customer/Tenant (F25).
/// </summary>
