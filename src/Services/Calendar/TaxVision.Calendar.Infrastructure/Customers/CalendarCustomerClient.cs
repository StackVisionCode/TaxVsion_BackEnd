...
namespace TaxVision.Calendar.Infrastructure.Customers;

public sealed class CustomerClientOptions
{
    public const string SectionName = "Calendar:Customer";
...
/// </summary>
internal sealed class CalendarCustomerClient(
    HttpClient httpClient,
    IServiceTokenAcquirer tokenAcquirer,
    ILogger<CalendarCustomerClient> logger
) : ICalendarCustomerClient
{
