...
/// <summary>
/// Cache de permisos por rol. Es lo que permite recomponer la unión de un usuario multi-rol cuando
/// cambia sólo uno de sus roles.
/// </summary>
public sealed class RolePermissionsProjection : TenantEntity
{
    ...
    /// <summary>El Id es el RoleId de Auth: clave natural, una fila por rol.</summary>
