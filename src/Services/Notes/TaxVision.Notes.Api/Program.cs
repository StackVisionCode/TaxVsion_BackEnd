...
// Fase 3: selección condicional al flag Authorization:PermissionsSource, igual que el resto
// del monorepo (guardrail 20). Flag OFF/ausente preserva el fallback Jwt.
