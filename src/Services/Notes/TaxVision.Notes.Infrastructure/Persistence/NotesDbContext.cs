...
/// <summary>
/// Fase 2 agregó los primeros DbSets reales (Note/NoteAttachment). Fase 3 agregó las
/// proyecciones RBAC (User/RolePermissionsProjection). Fase 4 agregó TenantPlanCodeProjection;
/// Fase 4B agregó la proyección de Customer (CustomerDirectoryEntry) + TenantBackfillState.
/// </summary>
...
/// </param>
public sealed class NotesDbContext(DbContextOptions<NotesDbContext> options, ITenantContext tenantContext)
    : DbContext(options),
        IUnitOfWork
{
