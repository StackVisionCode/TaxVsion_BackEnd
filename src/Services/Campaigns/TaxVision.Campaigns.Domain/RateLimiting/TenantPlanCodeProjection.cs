...
namespace TaxVision.Campaigns.Domain.RateLimiting;

/// <summary>
/// Proyección local de "¿qué PlanCode tiene este tenant hoy?", mismo patrón que Notes y que
/// <see cref="TaxVision.Campaigns.Domain.Permissions.UserPermissionsProjection"/> (RBAC) dentro de
...
///
/// <para>Gate de módulo (opt-in): persiste además los módulos habilitados del plan.</para>
/// </summary>
