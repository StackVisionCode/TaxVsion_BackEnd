...
namespace TaxVision.Reminder.Domain.RateLimiting;

/// <summary>
/// Proyección local de "¿qué PlanCode tiene este tenant hoy?", alimentada por
/// <c>TenantEntitlementsChangedIntegrationEvent</c> de Subscription. Es la mitad local del escalado
