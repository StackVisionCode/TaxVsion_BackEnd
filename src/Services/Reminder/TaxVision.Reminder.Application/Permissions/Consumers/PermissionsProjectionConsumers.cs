...
// ProjectionPermissionsSource (BuildingBlocks.Web) para enforzar perm_v sin llamar a Auth por HTTP
// en el hot path de autorización. Copiado del shape de Notes/CloudStorage/Signature a propósito,
// no improvisado: los dos bugs reales que ya costó este consumer fueron (a) un upsert que no
// comparaba PermissionsVersion y dejaba usuarios fail-closed en silencio sin DLQ, y (b) casing
