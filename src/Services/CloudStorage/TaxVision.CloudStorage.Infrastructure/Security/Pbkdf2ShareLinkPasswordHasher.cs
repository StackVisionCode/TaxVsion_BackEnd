...
/// <summary>Mismo esquema PBKDF2 que Auth.Infrastructure.Security.Pbkdf2PasswordHasher — contrasena opcional de un ShareLink publico.</summary>
public sealed class Pbkdf2ShareLinkPasswordHasher : IShareLinkPasswordHasher
{
