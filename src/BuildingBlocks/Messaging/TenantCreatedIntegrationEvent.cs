...
public sealed record TenantCreatedIntegrationEvent : IntegrationEvent
{
    ...
    /// POST auth/internal/invitations/token-references ANTES de publicar este evento, y solo la
    ...
    /// onboarding pagado (<c>POST tenants/internal/from-onboarding</c>). Los consumers de
