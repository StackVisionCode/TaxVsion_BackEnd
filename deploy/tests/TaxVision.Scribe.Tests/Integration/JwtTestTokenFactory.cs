...
/// <summary>
/// Mintea un JWT HS256 firmado con el secreto de test de <see cref="ScribeApiFactory"/> (nunca un
...
/// <c>TaxVision.Postmaster.Tests.Integration.JwtTestTokenFactory</c> (Fase 4.4).
/// </summary>
public static class JwtTestTokenFactory
{
    public static string Mint(ScribeApiFactory factory, Guid tenantId, Guid userId)
    {
