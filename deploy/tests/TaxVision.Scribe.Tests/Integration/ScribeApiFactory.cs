...
/// <summary>
/// Host real de Scribe.Api (SQL Server + Redis + RabbitMQ locales, sin mocks) para los tests de
/// integración de Fase 4.5 del plan de rate limiting — mismo patrón que
/// <c>TaxVision.Postmaster.Tests.Integration.PostmasterApiFactory</c> (Fase 4.4). La única
...
/// </summary>
public sealed class ScribeApiFactory : WebApplicationFactory<Program>
{
