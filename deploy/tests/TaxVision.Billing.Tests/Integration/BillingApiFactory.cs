...
/// <summary>
/// Host real de Billing.Api (SQL Server + Redis + RabbitMQ locales, sin mocks) para los tests de
/// integración de Fase 4.11 del plan de rate limiting — mismo patrón que
/// <c>TaxVision.Subscription.Tests.Integration.SubscriptionApiFactory</c> (Fase 4.10). La única
