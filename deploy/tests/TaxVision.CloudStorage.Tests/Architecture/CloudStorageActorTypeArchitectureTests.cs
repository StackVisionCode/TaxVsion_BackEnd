...
namespace TaxVision.CloudStorage.Tests.Architecture;
...
/// incluye <c>PublicShareController</c> (marcado <see cref="AllowAnonymousAttribute"/> a nivel de
/// clase), que queda exento igual que en runtime.
/// </summary>
public sealed class CloudStorageActorTypeArchitectureTests
{
    private static readonly Assembly ApiAssembly =
        typeof(TaxVision.CloudStorage.Api.Controllers.FilesController).Assembly;
