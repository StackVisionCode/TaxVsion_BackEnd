...
/// <summary>
/// Mintea un JWT HS256 firmado con el secreto de test de <see cref="PostmasterApiFactory"/>
...
/// <c>TaxVision.Tenant.Tests.Integration.JwtTestTokenFactory</c> (Fase 4.2) y
/// <c>TaxVision.Notification.Tests.Integration.JwtTestTokenFactory</c> (Fase 4.3).
/// </summary>
public static class JwtTestTokenFactory
{
    public static string Mint(PostmasterApiFactory factory, Guid tenantId, Guid userId)
    {
