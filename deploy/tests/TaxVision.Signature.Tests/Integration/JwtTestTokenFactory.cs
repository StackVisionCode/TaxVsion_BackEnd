...
/// <summary>
/// Mintea un JWT HS256 firmado con el secreto de test de <see cref="SignatureApiFactory"/>
...
/// <c>TaxVision.CloudStorage.Tests.Integration.JwtTestTokenFactory</c> (Fase 4.6).
/// </summary>
public static class JwtTestTokenFactory
{
    public static string Mint(SignatureApiFactory factory, Guid tenantId, Guid userId)
    {
