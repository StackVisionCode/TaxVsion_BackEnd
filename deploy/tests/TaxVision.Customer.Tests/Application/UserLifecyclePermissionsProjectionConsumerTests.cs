...
using TaxVision.Customer.Application.Consumers;
using TaxVision.Customer.Domain.Permissions;

namespace TaxVision.Customer.Tests.Application;

/// <summary>
/// Desactivar/retirar deja la proyección de AUTORIZACIÓN fail-closed; reactivar la vuelve a autorizar;
/// no-op si aún no existe. Distinta de TenantEmployeeDirectoryEntry (elegibilidad). Fakes de mano.
/// </summary>
