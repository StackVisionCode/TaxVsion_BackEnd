...
namespace TaxVision.Customer.Tests.Architecture;
...
/// </summary>
public sealed class CustomerActorTypeArchitectureTests
{
    private static readonly Assembly ApiAssembly =
        typeof(TaxVision.Customer.Api.Controllers.CustomerController).Assembly;
