...
/// <summary>
/// Host real de Correspondence.Api (SQL Server + Redis + RabbitMQ locales, sin mocks) para los
/// tests de integración de Fase 4.9 del plan de rate limiting — mismo patrón que
/// <c>TaxVision.Connectors.Tests.Integration.ConnectorsApiFactory</c> (Fase 4.8). La única
...
/// </summary>
public sealed class CorrespondenceApiFactory : WebApplicationFactory<Program>
{
