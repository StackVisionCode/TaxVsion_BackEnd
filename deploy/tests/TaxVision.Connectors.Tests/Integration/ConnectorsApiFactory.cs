...
/// <summary>
/// Host real de Connectors.Api (SQL Server + Redis + RabbitMQ locales, sin mocks) para los
/// tests de integración de Fase 4.8 del plan de rate limiting — mismo patrón que
/// <c>TaxVision.Signature.Tests.Integration.SignatureApiFactory</c> (Fase 4.7). La única
...
/// </summary>
public sealed class ConnectorsApiFactory : WebApplicationFactory<Program>
{
