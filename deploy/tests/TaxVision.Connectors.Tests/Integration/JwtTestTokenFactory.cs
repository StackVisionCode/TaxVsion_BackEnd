...
/// <summary>
/// Mintea un JWT HS256 firmado con el secreto de test de <see cref="ConnectorsApiFactory"/>
...
/// <c>TaxVision.Signature.Tests.Integration.JwtTestTokenFactory</c> (Fase 4.7).
/// </summary>
public static class JwtTestTokenFactory
{
    public static string Mint(ConnectorsApiFactory factory, Guid tenantId, Guid userId)
    {
