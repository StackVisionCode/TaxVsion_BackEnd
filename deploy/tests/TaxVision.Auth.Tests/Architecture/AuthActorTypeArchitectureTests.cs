...
/// </summary>
public sealed class AuthActorTypeArchitectureTests
{
    private static readonly Assembly ApiAssembly = typeof(TaxVision.Auth.Api.Controllers.UsersController).Assembly;
