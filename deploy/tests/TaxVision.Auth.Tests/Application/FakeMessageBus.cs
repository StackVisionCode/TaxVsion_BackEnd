...
/// <summary>
/// Fake mínimo de IMessageBus (Fase A6) — solo captura lo publicado vía PublishAsync;
/// todo lo demás no se usa en los handlers de TenantDomains y lanza si se llama.
/// </summary>
