...
/// <summary>
/// Mintea un JWT HS256 firmado con el secreto de test de <see cref="NotesApiFactory"/> (nunca un
...
/// <c>TaxVision.Correspondence.Tests.Integration.JwtTestTokenFactory</c>.
/// </summary>
public static class JwtTestTokenFactory
{
    public static string Mint(NotesApiFactory factory, Guid tenantId, Guid userId)
    {
