...
/// <summary>
/// Mintea un JWT HS256 firmado con el secreto de test de <see cref="NotificationApiFactory"/>
...
/// <c>TaxVision.Customer.Tests.Integration.JwtTestTokenFactory</c> (Fase 3) y
/// <c>TaxVision.Tenant.Tests.Integration.JwtTestTokenFactory</c> (Fase 4.2).
/// </summary>
public static class JwtTestTokenFactory
{
    public static string Mint(NotificationApiFactory factory, Guid tenantId, Guid userId)
    {
