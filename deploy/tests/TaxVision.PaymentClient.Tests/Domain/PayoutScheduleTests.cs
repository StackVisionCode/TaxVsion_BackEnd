...
public sealed class PayoutScheduleTests
{
    ...
    {
        var result = PayoutSchedule.Create(Guid.NewGuid(), Guid.NewGuid(), PayoutFrequency.Weekly, null, "USD", Guid.Empty, NowUtc);
    ...
    {
        var result = PayoutSchedule.Create(Guid.NewGuid(), Guid.NewGuid(), PayoutFrequency.Monthly, 32, "USD", Guid.Empty, NowUtc);
    ...
    {
        var result = PayoutSchedule.Create(Guid.NewGuid(), Guid.NewGuid(), PayoutFrequency.Manual, 1, "USD", Guid.Empty, NowUtc);
    ...
    {
        var result = PayoutSchedule.Create(Guid.NewGuid(), Guid.NewGuid(), PayoutFrequency.Weekly, 5, "USD", Guid.Empty, NowUtc);
    ...
    {
        var schedule = PayoutSchedule.Create(Guid.NewGuid(), Guid.NewGuid(), PayoutFrequency.Weekly, 3, "USD", Guid.Empty, NowUtc).Value;
    ...
    {
        var schedule = PayoutSchedule.Create(Guid.NewGuid(), Guid.NewGuid(), PayoutFrequency.Manual, null, "USD", Guid.Empty, NowUtc).Value;
