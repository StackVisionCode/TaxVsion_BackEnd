...
namespace TaxVision.PaymentClient.Tests.Architecture;
...
/// incluye <c>HostedCheckoutController</c> (namespace <c>Public</c>, marcado
/// <see cref="AllowAnonymousAttribute"/>), que queda exento igual que en runtime.
/// </summary>
public sealed class PaymentClientActorTypeArchitectureTests
{
    private static readonly Assembly ApiAssembly =
        typeof(TaxVision.PaymentClient.Api.Controllers.PaymentLinksController).Assembly;
