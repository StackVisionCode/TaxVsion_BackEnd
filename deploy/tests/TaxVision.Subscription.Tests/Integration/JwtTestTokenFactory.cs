...
/// <summary>
/// Mintea un JWT HS256 firmado con el secreto de test de <see cref="SubscriptionApiFactory"/>
...
/// <c>TaxVision.Correspondence.Tests.Integration.JwtTestTokenFactory</c> (Fase 4.9).
/// </summary>
public static class JwtTestTokenFactory
{
    public static string Mint(SubscriptionApiFactory factory, Guid tenantId, Guid userId)
    {
