...
namespace TaxVision.Subscription.Tests.Architecture;
...
/// incluye <c>PlansController.GetPlans</c> (catálogo público, marcado
/// <see cref="AllowAnonymousAttribute"/> a nivel de acción), que queda exento igual que en runtime.
/// </summary>
public sealed class SubscriptionActorTypeArchitectureTests
{
    private static readonly Assembly ApiAssembly =
        typeof(TaxVision.Subscription.Api.Controllers.SubscriptionsController).Assembly;
