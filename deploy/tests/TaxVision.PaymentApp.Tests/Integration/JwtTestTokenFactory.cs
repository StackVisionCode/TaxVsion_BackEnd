...
/// <summary>
/// Mintea un JWT HS256 firmado con el secreto de test de <see cref="PaymentAppApiFactory"/> (nunca
...
/// [HasPermission] (ver doc-comment de Program.cs: "los admins pasan siempre"). Mismo patrón que
/// <c>TaxVision.Auth.Tests.Integration.JwtTestTokenFactory</c> (Fase 4.12).
/// </summary>
public static class JwtTestTokenFactory
{
    public static string Mint(PaymentAppApiFactory factory, Guid tenantId, Guid userId)
    {
