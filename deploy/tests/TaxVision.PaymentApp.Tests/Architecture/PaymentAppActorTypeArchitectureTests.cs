...
/// el webhook de Stripe, marcado <see cref="AllowAnonymousAttribute"/>, queda exento igual que en
/// runtime.
/// </summary>
public sealed class PaymentAppActorTypeArchitectureTests
{
    private static readonly Assembly ApiAssembly =
        typeof(TaxVision.PaymentApp.Api.Controllers.SaaSPaymentsController).Assembly;
