...
/// <summary>
/// Mintea un JWT HS256 firmado con el secreto de test de <see cref="GrowthApiFactory"/> (nunca un
...
/// <c>[HasPermission]</c> (<c>ActorTypeAuthorizationFilter</c>: "ActorType.PlatformAdmin siempre
/// pasa"). Mismo patrón que <c>TaxVision.PaymentClient.Tests.Integration.JwtTestTokenFactory</c>
/// (Fase 4.14).
/// </summary>
public static class JwtTestTokenFactory
{
    public static string Mint(GrowthApiFactory factory, Guid tenantId, Guid userId)
    {
