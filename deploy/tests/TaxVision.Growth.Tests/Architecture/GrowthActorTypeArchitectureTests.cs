...
/// Growth usa alias de <c>using</c> en sus controllers para evitar ambigüedad con su propia
/// <c>HasPermissionAttribute</c> local, pero el atributo aplicado en runtime sigue siendo
/// <see cref="AllowActorTypesAttribute"/> de BuildingBlocks — la reflexión de este test lo
/// encuentra igual, sin necesidad de tratamiento especial.
/// </summary>
public sealed class GrowthActorTypeArchitectureTests
{
    private static readonly Assembly ApiAssembly = typeof(TaxVision.Growth.Api.Controllers.CodesController).Assembly;
    ...
    /// acción o heredado del controller. Mismo patrón de reflexión que
    /// <see cref="Controller_actions_should_declare_AllowActorTypes"/> arriba. Los endpoints de
    /// <c>/health/*</c> quedan afuera por construcción — no son acciones MVC.
    /// </summary>
    [Fact]
