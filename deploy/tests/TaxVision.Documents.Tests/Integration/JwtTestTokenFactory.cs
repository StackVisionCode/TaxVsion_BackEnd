...
/// <summary>
/// Mintea un JWT HS256 firmado con el secreto de test de <see cref="DocumentsApiFactory"/> (nunca un
...
/// pasa"). Mismo patrón que <c>TaxVision.Growth.Tests.Integration.JwtTestTokenFactory</c>
/// (Fase 4.15).
/// </summary>
public static class JwtTestTokenFactory
{
    public static string Mint(DocumentsApiFactory factory, Guid tenantId, Guid userId)
    {
