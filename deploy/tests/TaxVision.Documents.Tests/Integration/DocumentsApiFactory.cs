...
/// <summary>
/// Host real de Documents.Api (SQL Server + Redis + RabbitMQ locales, sin mocks) para los tests de
/// integración de Fase 4.16 del plan de rate limiting — mismo patrón que
/// <c>TaxVision.Growth.Tests.Integration.GrowthApiFactory</c> (Fase 4.15). La única sustitución
/// respecto al Program.cs real es la clave de firma JWT: se sobreescribe con un secreto HS256
