...
namespace TaxVision.Tenant.Tests.Architecture;
...
/// </summary>
public sealed class TenantActorTypeArchitectureTests
{
    private static readonly Assembly ApiAssembly = typeof(TaxVision.Tenant.Api.Controllers.TenantController).Assembly;
